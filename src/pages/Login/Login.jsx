...
const Login = () => {
  ...
  const { googleSign } = use(AuthContext);
  ...
  return (
    <div className="p-5 min-h-[calc(100vh-96px)] flex flex-col items-center justify-center">
      <div className="sm:min-w-[570px] border-2 border-slate-200 rounded p-5">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6 mt-5">
          <input
            type="email"
            name="email"
            className="w-full border-b p-2 border-slate-200 outline-none text-base font-medium"
